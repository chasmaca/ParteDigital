  ...
  var ui = {
      ...
      4: {
        ...
        html: {
          ...
          pageDropdownItem: '<a class="dropdown-item %s" href="#" style="color:white;">%s</a>',
      ...
      formatShowingRows: function (e, t, o, a) {
        return void 0 !== a && 0 < a && a > o
          ? "Showing "
              ...
              .concat(a, " total rows)")
          : "Showing ".concat(e, " to ").concat(t, " of ").concat(o, " rows");
      },
                ...
                this.$body
                  ...
                  .on("click", function (a) {
                    return (
                      a.preventDefault(),
                      o.toggleDetailView(
                        t(a.currentTarget).parent().parent().data("index")
                      ),
                      !1
                    );
                  }),
            ...
            value: function (e) {
              ...
              try {
                for (
                  var s,
                    l,
                    r = this.columns.slice().reverse()[Symbol.iterator]();
                  !(a = (s = r.next()).done);
                  a = !0
                )
