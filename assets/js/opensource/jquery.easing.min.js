...
(function(h) {
    ...
    h.extend(h.easing, {
        ...
        easeInElastic: function(e, a, c, b, d) { e = 1.70158; var f = 0,
                g = b; if (0 == a) return c; if (1 == (a /= d)) return c + b;
            f || (f = .3 * d);
            g < Math.abs(b) ? (g = b, e = f / 4) : e = f / (2 * Math.PI) * Math.asin(b / g); return -(g * Math.pow(2, 10 * --a) * Math.sin(2 * (a * d - e) * Math.PI / f)) + c },
        ...
        easeInOutElastic: function(e, a, c, b, d) { e = 1.70158; var f = 0,
