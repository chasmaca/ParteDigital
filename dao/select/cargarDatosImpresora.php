...
function recuperamosGastos($periodoCierre)
{
    ...
    global $mysqlCon,$recuperaGastosImpresoraCierre;
    ...
    if ($stmt = $mysqlCon->prepare($recuperaGastosImpresoraCierre)) {
        ...
        /*Almacenamos el resultSet*/
            ...
            /*Almacenamos el resultSet*/
        $stmt->bind_result($departamento_id, $periodo, $byn_unidades, $byn_precio, $byn_total, $color_unidades, $color_precio, $color_total);
